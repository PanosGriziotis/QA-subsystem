...
Download the Wikipedia Dump and Extract:
...
Clean and Extract Using WikiExtractor:
...
Step 3: Filter and Convert to Documents

Run filter_and_convert_to_docs.py to further preprocess and filter the cleaned Wikipedia documents.
